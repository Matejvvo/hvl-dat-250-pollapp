package no.hvl.dat250.pollapp.jpa;
...
public class PollsTest {
    ...
    public void setUp() {
        EntityManagerFactory emf = new PersistenceConfiguration("polls")
                ...
                .property(PersistenceConfiguration.JDBC_URL, "jdbc:h2:mem:pollstest")
//                .property(PersistenceConfiguration.JDBC_URL, "jdbc:h2:file:./polls-db")
