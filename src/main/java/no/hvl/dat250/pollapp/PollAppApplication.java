...
//
//        pollService.setPollRepo(pollRepo);
//        pollService.setUserRepo(userRepo);
//        pollService.setVoteRepo(voteRepo);
//
//        userService.setPollRepo(pollRepo);
//        userService.setUserRepo(userRepo);
//        userService.setVoteRepo(voteRepo);
//
//        voteService.setPollRepo(pollRepo);
//        voteService.setUserRepo(userRepo);
//        voteService.setVoteRepo(voteRepo);
//
//        // Create a new user
